...
import { Trophy, TROPHIES, checkNewTrophies, UserStats, getEffectiveLevel, getDailyGoalMinutesForLevel } from '@/core/services/gamification';
import { startOfWeek, addDays, format, isSameDay, isAfter } from "date-fns";
import { ptBR } from "date-fns/locale";
import { getDayKey, getDayBoundsUTC, getTodayKey } from '@/core/utils/timezone-utils';
