...
const novidades: NovidadeItem[] = [
  {
    ...
    title: "Comunidade Muzze",
    description: "Conecte-se com outros criadores, compartilhe ideias e inspire-se. A comunidade Muzze está chegando para transformar sua experiência criativa!",
    icon: Users,
