...
import { sanitizeHtmlContent } from '@/core/utils';
import {
  DndContext,
  closestCenter,
  DragEndEvent,
...
import { useLongPressSensors } from '@/core/hooks';
      ...
      <td className="p-4 w-80 min-w-0 align-top">
        <div className="flex flex-col gap-2 w-full max-w-full min-w-0">
          ...
          <RichTextEditor
            ...
            minHeight="80px"
          />
          <span className="text-xs text-muted-foreground hidden md:inline">Shift+Enter: novo take</span>
        </div>
      </td>
